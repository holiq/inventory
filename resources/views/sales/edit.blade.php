<x-app-layout>
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Sale</h3>
                    <p class="text-subtitle text-muted">Update sale transaction</p>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="customer_id" class="form-label">Sustomer <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="description"
                                                   name="description"
                                                   value="{{ old('description', $sale->description) }}"
                                    ...
                                    <table class="table table-bordered" id="itemsTable">
                                        ...
                                        <tbody id="itemsTableBody">
                                            ...
                                            @else
                                                ...
                                                @empty
                                                    {{-- kalau sale belum punya item, kasih 1 baris default --}}
                                                    <tr class="item-row">
                                                        <td>
    ...
    <script>
        ...
        let itemIndex = {{ max(1, count(old('items', [])) ?: ($sale->items->count() ?? 1)) }};
