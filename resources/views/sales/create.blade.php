<x-app-layout>
    <x-slot name="title">Add New Sale</x-slot>
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Add New Sale</h3>
                    <p class="text-subtitle text-muted">Create a new sale transaction</p>
                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h4 class="card-title mb-0">Sale Items</h4>
                                    ...
                                    <table class="table table-bordered" id="itemsTable">
                                        ...
                                        <tbody id="itemsTableBody">
                                            <tr class="item-row">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control form-control-sm form-amount price-input" name="items[0][price]" value="0" required>
                                                </td>
                                                <td>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#addItemBtn').click(function() {
                const newRow = `
                    <tr class="item-row">
                        ...
                        <td>
                            <input type="text" class="form-control form-control-sm form-amount price-input" name="items[${itemIndex}][price]" value="0" required>
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm subtotal-display" readonly value="Rp 0">
                        </td>
            ...
            $(document).on('change', '.product-select', function() {
                ...
                $(this).closest('tr').find('.price-input').val(price).trigger('input.currency');
            ...
            function calculateRowSubtotal(row) {
                ...
                row.find('.subtotal-display').val('Rp ' + formatCurrency(subtotal));
                calculateTotal();
            }
            ...
            function calculateTotal() {
                ...
                $('#totalPrice').text('Rp ' + formatCurrency(totalPrice));
            }
